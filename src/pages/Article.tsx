          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="animate-fade-in-up" style={{ animationDelay: '0.8s' }}>
              ...
              <div className="bg-muted/50 rounded-2xl p-8 text-sm text-muted-foreground space-y-3 border border-border">
                <p>Xu, J., Xiang, L., Zhang, H., Sun, X., Xu, D., Wu, D., Chen, C., Zhang, Y., & Gu, Z. (2024). Prevalence and modifiable risk factors of cognitive frailty in patients with chronic heart failure in China: a cross-sectional study. BMC Cardiovascular Disorders. <a href="https://doi.org/10.1186/s12872-024-03753-x" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">https://doi.org/10.1186/s12872-024-03753-x</a></p>
                <p>Rathore, M. (2022). Congestive heart failure. International Journal of Advance Research in Nursing. <a href="https://doi.org/10.33545/nursing.2022.v5.i1a.226" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">https://doi.org/10.33545/nursing.2022.v5.i1a.226</a></p>
                <p>Santiago, G. G., Gomez, A. M., Gonzalez, G. A., Ramos, O. J. L., Castro, A. A., & Pere, M. B. L. (2023). Review of best treatment option in heart failure 2023. International Journal of Advances in Medicine. <a href="https://doi.org/10.18203/2349-3933.ijam20233512" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">https://doi.org/10.18203/2349-3933.ijam20233512</a></p>
                <p>Ali, A., et al. (2018). American Heart Association High Blood Pressure Protocol 2017: A Literature Review. Cureus. <a href="https://doi.org/10.7759/cureus.3230" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">https://doi.org/10.7759/cureus.3230</a></p>
                <p>Nichols, G. A., Hillier, T. A., Erbey, J. R., Brown, J. B. (2001). Congestive Heart Failure in Type 2 Diabetes: Prevalence, incidence, and risk factors. Diabetes Care. <a href="https://doi.org/10.2337/diacare.24.9.1614" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">https://doi.org/10.2337/diacare.24.9.1614</a></p>
              </div>
            </section>
          </div>
